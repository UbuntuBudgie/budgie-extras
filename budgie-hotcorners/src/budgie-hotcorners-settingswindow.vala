...
namespace HotCornerSettings {
    ...
    class HotCornerSettingsWindow : Gtk.Window {
        ...
        public HotCornerSettingsWindow () {
            ...
            string title = _("Hotcorners settings");
            ...
            masterswitchbox.pack_start (
                makelabel(_("Activate hotcorners"), {0, 0, 0, 0}, "justbold")
            );
            ...
            maingrid.attach (
                makelabel(
                    _("Corner settings"), {0, 0, 0, 20}, "justbold"), 0, 2, 10, 1
            );
            maingrid.attach (makelabel(
                _("Click a spot to edit"), {0, 0, 0, 20}, "justitalic"), 0, 3, 10, 1);
            /* pages section */
            make_pages();
            ...
            /* Pressure section */
            maingrid.attach (makelabel(_("Pressure"), {0, 0, 0, 10}, "justitalic"), 0, 45, 10, 1);
        ...
        private void make_pages () {
            ...
            for (int i=0; i<8; i++) {
                ...
                onoffswitch.set_tooltip_text(_("Toggle hotcorner on-off"));
                ...
                togglecustom.set_tooltip_text(_("Set a custom command"));

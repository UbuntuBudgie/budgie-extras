Budgie HotCorners (applet) adds hot corner functionality to the desktop. Enable the hot corner by clicking the toggle button and subsequently add the command to the entry. 
